def kuwahara_cantos(y, x, planoBGR, largura, altura):
    if y == 0:
        if x == 0:
            return sum([planoBGR[y, x], planoBGR[y, x + 1], planoBGR[y, x + 2],
                        planoBGR[y + 1, x], planoBGR[y + 1, x + 1], planoBGR[y + 1, x + 2],
                        planoBGR[y + 2, x], planoBGR[y + 2, x + 1], planoBGR[y + 2, x + 2]]) / 9
...
def kuwahara_meioCantos(y, x, plano_brilho, plano_BGR, largura, altura):
    janela1 = []
    janela2 = []
    janela1bgr = []
    janela2bgr = []
    ...
    if y == 0:
        if x == 1:
            janela1 = [plano_brilho[y, x-1], plano_brilho[y, x],
                       plano_brilho[y+1, x-1], plano_brilho[y+1, x],
                       plano_brilho[y+2, x-1], plano_brilho[y+2, x]]
            janela2 = [plano_brilho[y, x], plano_brilho[y, x + 1], plano_brilho[y, x + 2],
                       plano_brilho[y + 1, x], plano_brilho[y + 1, x + 1], plano_brilho[y + 1, x + 2],
                       plano_brilho[y + 2, x], plano_brilho[y + 2, x + 1], plano_brilho[y + 2, x + 2]]
            janela1bgr = [plano_BGR[y, x - 1], plano_BGR[y, x],
                          plano_BGR[y + 1, x - 1], plano_BGR[y + 1, x],
                          plano_BGR[y + 2, x - 1], plano_BGR[y + 2, x]]
            janela2bgr = [plano_BGR[y, x], plano_BGR[y, x + 1], plano_BGR[y, x + 2],
                          plano_BGR[y + 1, x], plano_BGR[y + 1, x + 1], plano_BGR[y + 1, x + 2],
                          plano_BGR[y + 2, x], plano_BGR[y + 2, x + 1], plano_BGR[y + 2, x + 2]]

        elif x == largura-2:
            janela2 = [plano_brilho[y, x], plano_brilho[y, x-1], plano_brilho[y, x-2],
                       plano_brilho[y+1, x], plano_brilho[y+1, x-1], plano_brilho[y+1, x-2],
                       plano_brilho[y+2, x], plano_brilho[y+2, x-1], plano_brilho[y+2, x-2]]
            janela1 = [plano_brilho[y, x], plano_brilho[y, x+1],
                       plano_brilho[y+1, x], plano_brilho[y+1, x+1],
                       plano_brilho[y+2, x], plano_brilho[y+2, x+1]]

            janela2bgr = [plano_BGR[y, x], plano_BGR[y, x - 1], plano_BGR[y, x - 2],
                          plano_BGR[y + 1, x], plano_BGR[y + 1, x - 1], plano_BGR[y + 1, x - 2],
                          plano_BGR[y + 2, x], plano_BGR[y + 2, x - 1], plano_BGR[y + 2, x - 2]]
            janela1bgr = [plano_BGR[y, x], plano_BGR[y, x + 1],
        ...
        if x == 1:
            janela1 = [plano_brilho[y, x-1], plano_brilho[y, x],
                       plano_brilho[y-11, x-1], plano_brilho[y-1, x],
                       plano_brilho[y-2, x-1], plano_brilho[y-2, x]]
            janela2 = [plano_brilho[y, x], plano_brilho[y, x + 1], plano_brilho[y, x + 2],
                       plano_brilho[y - 1, x], plano_brilho[y - 1, x + 1], plano_brilho[y - 1, x + 2],
                       plano_brilho[y - 2, x], plano_brilho[y - 2, x + 1], plano_brilho[y - 2, x + 2]]
            ...
            janela1bgr = [plano_BGR[y, x - 1], plano_BGR[y, x],
                          plano_BGR[y - 11, x - 1], plano_BGR[y - 1, x],
                          plano_BGR[y - 2, x - 1], plano_BGR[y - 2, x]]
            janela2bgr = [plano_BGR[y, x], plano_BGR[y, x + 1], plano_BGR[y, x + 2],
                          plano_BGR[y - 1, x], plano_BGR[y - 1, x + 1], plano_BGR[y - 1, x + 2],
                          plano_BGR[y - 2, x], plano_BGR[y - 2, x + 1], plano_BGR[y - 2, x + 2]]
            ...
            if x == 0:
                janela1 = [plano_brilho[y-1, x], plano_brilho[y-1, x+1], plano_brilho[y-1, x+2],
                ...
                janela1bgr = [plano_BGR[y - 1, x], plano_BGR[y - 1, x + 1], plano_BGR[y - 1, x + 2],
                              plano_BGR[y, x], plano_BGR[y, x + 1], plano_BGR[y, x + 2]]
    ...
    for j in range(9):
        soma_dos_quadrados2 += (media_janela2 - janela2[j])**2
...
def kuwahara_cantos_internos(y, x, plano_brilho, plano_BGR, largura, altura):
    janela1 = []
    janela2 = []
    janela3 = []
    janela4 = []
    ...
    if y == 1:
        if x == 1:
            ...
            janela3 = [plano_brilho[y, x], plano_brilho[y, x-1],
                       plano_brilho[y+1, x], plano_brilho[y+1, x-1],
                       plano_brilho[y+2, x], plano_brilho[y+2, x-1]]
            ...
            janela3BGR = [plano_BGR[y, x], plano_BGR[y, x-1],
                          plano_BGR[y+1, x], plano_BGR[y+1, x-1],
                          plano_BGR[y+2, x], plano_BGR[y+2, x-1]]

            janela4BGR = [plano_BGR[y, x], plano_BGR[y, x+1], plano_BGR[y, x+2],
                          plano_BGR[y+1, x], plano_BGR[y+1, x+1], plano_BGR[y+1, x+2],
                          plano_BGR[y+2, x], plano_BGR[y+2, x+1], plano_BGR[y+2, x+2]]
            ...
            janela2 = [plano_brilho[y, x], plano_brilho[y, x-1], plano_brilho[y, x-2],
                       plano_brilho[y-1, x], plano_brilho[y-11, x-1], plano_brilho[y-1, x-2]]
            ...
            janela2BGR = [plano_BGR[y, x], plano_BGR[y, x-1], plano_BGR[y, x-2],
                          plano_BGR[y-1, x], plano_BGR[y-11, x-1], plano_BGR[y-1, x-2]]
    ...
    media_janela1 = sum(janela1)/4
    media_janela2 = sum(janela2)/6
    media_janela3 = sum(janela3)/6
    ...
    for j in range(6):
        soma_quadrados2 += (media_janela2*janela2[j])**2
        soma_quadrados3 += (media_janela3-janela3[j])**2
    for x in range(9):
        soma_quadrados4 += (media_janela4-janela4[x])**2
...
def define_janela_arestas(y, x, plano_brilho, largura, altura):
    janela1 = []
    janela2 = []

    if y == 0:
        janela1 = [plano_brilho[y, x], plano_brilho[y, x-1], plano_brilho[y, x-2],
                   plano_brilho[y+1, x], plano_brilho[y+1, x-1], plano_brilho[y+1, x-2]]
        ...
        janela2 = [plano_brilho[y, x], plano_brilho[y, x+1],
                   plano_brilho[y+1, x], plano_brilho[y+1, x+1],
                   plano_brilho[y+2, x], plano_brilho[y+2, x+1]]
...
def kuwahara_arestaS_internas(y, x, plano_brilho, largura, altura):
    ...
    return janela_menor_variancia


def define_janela_menor_variancia_meios(y, x, plano_brilho):

    janela1 = [plano_brilho[y-2, x-2], plano_brilho[y-2, x-1], plano_brilho[y-2, x],
               plano_brilho[y-1, x-2], plano_brilho[y-1, x-1], plano_brilho[y-1, x],
               plano_brilho[y, x-2], plano_brilho[y, x-1], plano_brilho[y, x]]

    janela2 = [plano_brilho[y-2, x], plano_brilho[y-2, x+1], plano_brilho[y-2, x+2],
               plano_brilho[y-1, x], plano_brilho[y-1, x+1], plano_brilho[y-1, x+2],
               plano_brilho[y, x], plano_brilho[y, x+1], plano_brilho[y, x+2]]
